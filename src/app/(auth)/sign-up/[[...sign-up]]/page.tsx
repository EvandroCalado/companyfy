            ...
            <>
              <SignUp.Step name='start'>
                <Card className='w-full sm:w-96'>
                  ...
                  <CardHeader>
                    ...
                    <CardDescription>
                      Bem Viado! Insira seus dados para criar uma conta.
                    </CardDescription>
                  </CardHeader>
              ...
              <SignUp.Step name='continue'>
                <Card className='w-full sm:w-96'>
                  <Logo className='mx-auto' />
                  <CardHeader>
                    <CardTitle>Continuar com o cadastro</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <Clerk.Field name='username' className='space-y-2'>
                      <Clerk.Label>
                        <Label>Nome de usuário</Label>
                      </Clerk.Label>
                ...
                <SignUp.Strategy name='email_code'>
                  <Card className='w-full sm:w-96'>
                    ...
                    <CardHeader>
                      ...
                      <CardDescription>
                        Use o link de verificação para concluir o cadastro.
                      </CardDescription>
                    </CardHeader>
                    <CardContent className='grid gap-y-4'>
